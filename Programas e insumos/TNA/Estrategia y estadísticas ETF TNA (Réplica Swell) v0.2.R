###  Estrategia y estadísticas ETF TNA (Réplica Swell)  ###
###                     2021-03-18                      ###
###                     Version 0.2                     ###  
...
ArchivoCargue <- "Data ETF TNA.xlsx"
BDPI <- read_excel(ArchivoCargue, sheet = "DATOS TNA")
...
View(BDPSList$BDP_I5_R9$BDPS)
BDPSList$BDP_I5_R9$Graf_UtilidadAcum
