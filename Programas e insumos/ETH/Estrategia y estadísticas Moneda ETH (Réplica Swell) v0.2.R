###  Estrategia y estadísticas Moneda ETH (Réplica Swell)  ###
###                     2021-03-18                         ###
###                     Version 0.2                        ###  
...
ArchivoCargue <- "Data Moneda ETH.xlsx"
BDPI <- read_excel(ArchivoCargue, sheet = "DATOS ETH")
...
#NFHC <- 0 # Número de FH descartadas para negociar antes del cierre
...
#OS: en monedas no descarto ninguna FH
...
View(BDPSList$BDP_I6_R6$BDPS)
BDPSList$BDP_I5_R6$Graf_UtilidadAcum
