###  Estrategia y estadísticas Moneda BTC (Réplica Swell)  ###
###                     2021-03-18                         ###
###                     Version 0.2                        ###  
...
ArchivoCargue <- "Data Moneda BTC.xlsx"
BDPI <- read_excel(ArchivoCargue, sheet = "DATOS BTC")
...
View(BDPSList$BDP_I5_R5$BDPS)
BDPSList$BDP_I5_R5$Graf_UtilidadAcum
