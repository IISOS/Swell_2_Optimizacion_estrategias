###  Estrategia y estadísticas ETF SPXL (Réplica Swell)  ###
###                     2021-03-18                      ###
###                     Version 0.2                     ###  
...
BDPI <- read_excel(ArchivoCargue, sheet = "DATOS SPXL")
...
View(BDPSList$BDP_I8_R7$BDPS)
BDPSList$BDP_I8_R7$Graf_UtilidadAcum
