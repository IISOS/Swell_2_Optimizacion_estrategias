###  Estrategia y estadísticas ETF FAZ (Réplica Swell)  ###
###                     2021-03-18                      ###
###                     Version 0.2                     ###  
...
ArchivoCargue <- "Data ETF FAZ.xlsx"
BDPI <- read_excel(ArchivoCargue, sheet = "DATOS FAZ")
...
View(BDPSList$BDP_I9_R9$BDPS)
BDPSList$BDP_I9_R9$Graf_UtilidadAcum
